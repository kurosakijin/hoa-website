const defaultLandingPageContent = {
  brandShortName: 'Sitio Hiyas',
  brandFullName: 'Homeowners Association',
  navHomeLabel: 'Home',
  navCommunityLabel: 'Community',
  navAboutLabel: 'About',
  heroEyebrow: 'Sitio Hiyas community welcome',
  heroTitle: 'Sitio Hiyas Homeowners Association',
  heroDescription:
  ...
  primaryCtaLabel: 'Resident Guide',
  secondaryCtaLabel: 'Find My Resident Info',
  communityEyebrow: 'Community overview',
  communityTitle: 'A public homepage that feels like a real subdivision website',
  ...
  aboutEyebrow: 'About',
  aboutTitle: 'A cleaner front door for Sitio Hiyas',
  aboutParagraphOne:
  ...
  detailsEyebrow: 'Association details',
  detailsTitle: 'Public details first, resident tools second',
};
