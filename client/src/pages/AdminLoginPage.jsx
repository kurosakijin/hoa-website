...
function AdminLoginPage() {
  ...
  return (
    <main className="mx-auto grid min-h-[calc(100vh-88px)] max-w-7xl items-center gap-8 px-4 py-10 lg:grid-cols-[0.95fr_1.05fr] lg:px-6">
      <section className="surface-card p-8 lg:p-10">
        ...
        <p className="mt-4 max-w-xl text-base leading-7 text-slate-300">
          This area is reserved for administrators managing resident records, transfers, balances, and posted payments.
        </p>
